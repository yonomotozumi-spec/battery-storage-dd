...
A_PX=(1086.0,240.0); A_LL=(34.962386,137.231893)   # 求積図px(道路東端@分岐) ≈ 01キ401（配置図で道路東側の電柱）
def k2ll(u,v):
    return A_LL[0]+(A_PX[1]-v)*MPP/KY, A_LL[1]+(u-A_PX[0])*MPP/KX
pts={'26番4 北端付近':(1035,96),'26番4 ラベル位置':(1026,138),'26番4 可用部分の中心':(1031,168),'26番4 南端付近（幅4m）':(1052,300),
